...
#import "ZBNHTOrderUnknowCell.h"
#import "ZBNHTComDetailModel.h"

@interface ZBNHTOrderUnknowVC ()
/*! 模型数据 */
@property (nonatomic, strong) ZBNHTComDetailModel *detailM;
@end

@implementation ZBNHTOrderUnknowVC
...
{
    ZBNHTOrderUnknowCell *cell = [[NSBundle mainBundle] loadNibNamed:@"ZBNHTOrderUnknowCell" owner:nil options:nil].lastObject;
