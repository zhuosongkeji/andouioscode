...
@interface ZBNHTOrderNotPayVC ()
/*! 模型数据 */
@property (nonatomic, strong) ZBNHTComDetailModel *detailM;
@end

@implementation ZBNHTOrderNotPayVC
...
{
    ZBNHTOrderNotPayCell *cell = [[NSBundle mainBundle] loadNibNamed:@"ZBNHTOrderNotPayCell" owner:nil options:nil].lastObject;
