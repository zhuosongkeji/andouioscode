...
#import "ZBNHTOrderComedCell.h"
#import "ZBNHTComDetailModel.h"

@interface ZBNHTOrderComedVC ()
/*! 模型数据 */
@property (nonatomic, strong) ZBNHTComDetailModel *detailM;
@end

@implementation ZBNHTOrderComedVC
...
{
    ZBNHTOrderComedCell *cell = [[NSBundle mainBundle] loadNibNamed:@"ZBNHTOrderComedCell" owner:nil options:nil].lastObject;
