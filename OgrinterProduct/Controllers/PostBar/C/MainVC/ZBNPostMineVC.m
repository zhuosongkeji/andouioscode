...
@interface ZBNPostMineVC () <ZBNPostCommentDelegate,ZBNPostBarHeaderDelegate,ZBNPostBarHeaderDelegate>
/*! 保存数据的数组 */
...
{
    ZBNPostCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:ZBNPostMineCellId];
