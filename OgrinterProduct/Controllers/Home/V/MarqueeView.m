...
//        UIImageView *imgV = [[UIImageView alloc]initWithFrame:CGRectMake(10, (self.frame.size.height - 20 )/2, 20, 20)];
//        imgV.image = img;
//        UILabel *tagLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, (self.frame.size.height - 20 )/2, 40, 20)];
//        tagLabel.text = text;
