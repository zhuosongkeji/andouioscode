//
//  CategorySetingViewController.m
//  OgrinterProduct
//
//  Created by wongshine on 2019/12/21.
...
@interface CategorySetingViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, OrgMoveCellCollectionViewDataSource,OrgMoveCellCollectionViewDelegate, UICollectionViewDelegateFlowLayout>{
...
@implementation CategorySetingViewController
...
-(void)setup {
    ...
    flowLayout.itemSize                 = CGSizeMake((KSCREEN_WIDTH - ViewToXWidth * 2) / 3.0, itemCellHeight);
    flowLayout.sectionInset             = UIEdgeInsetsMake(0.f, 0.f, 0.f, 0.f);
    flowLayout.minimumLineSpacing       = 0.f;
    flowLayout.minimumInteritemSpacing  = 0.f;
    
    self.collectionView = [[CustomMoveView alloc]initWithFrame:CGRectMake(ViewToXWidth, kStatusBarAndNavigationBarH, KSCREEN_WIDTH - ViewToXWidth * 2.0, KSCREEN_HEIGHT - sureBtnHeight - 20.f) collectionViewLayout:flowLayout];
    ...
    UIButton * sureBtn  = [CGControl createButtonWithFrame:CGRectMake(0, KSCREEN_HEIGHT - sureBtnHeight, KSCREEN_WIDTH, sureBtnHeight) title:@"完 成" imageName:nil bgImageName:nil target:self method:@selector(sureButton:)];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section {
    return CGSizeMake(KSCREEN_WIDTH, 45.f);
}

- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section {
    return CGSizeMake(KSCREEN_WIDTH, 0.f);
}
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if([kind isEqual:UICollectionElementKindSectionHeader]) {
        ...
        if (indexPath.section == 0) {
            ...
            self.exitButton.frame     = CGRectMake(KSCREEN_WIDTH - 44.f, 18.f, 14.f, 14.f);
