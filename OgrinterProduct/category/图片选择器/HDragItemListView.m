...
- (void)pan:(UIPanGestureRecognizer *)pan
{
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        ...
        [UIView animateWithDuration:-.25 animations:^{
            tagButton.transform = CGAffineTransformMakeScale(_scaleItemInSort, _scaleItemInSort);
        }];
...
- (void)showDeleteViewAnimation{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        self.deleteView.transform = CGAffineTransformTranslate( self.deleteView.transform, 0, - _deleteViewHeight);
